...
public class MediaButtonIntentReceiver extends BroadcastReceiver {
        ...
        public void handleMessage(final Message msg) {
            switch (msg.what) {
                case MSG_HEADSET_DOUBLE_CLICK_TIMEOUT:
                    ...
                    switch (clickCount) {
                        case 1:
                            command = MusicPlayerService.ACTION_TOGGLE_PAUSE;
                            break;
                        case 2:
                            command = MusicPlayerService.ACTION_SKIP;
                            break;
                        case 3:
                            command = MusicPlayerService.ACTION_REWIND;
                            break;
                        default:
                            command = null;
                            break;
        ...
        if (Intent.ACTION_MEDIA_BUTTON.equals(intentAction)) {
            ...
            switch (keycode) {
                case KeyEvent.KEYCODE_MEDIA_STOP:
                    command = MusicPlayerService.ACTION_STOP;
                    break;
                ...
                case KeyEvent.KEYCODE_MEDIA_NEXT:
                    //Logger.d("调用 KEYCODE_MEDIA_NEXT");
                    command = MusicPlayerService.ACTION_SKIP;
                    break;
                ...
                case KeyEvent.KEYCODE_MEDIA_PAUSE:
                    command = MusicPlayerService.ACTION_PAUSE;
                    break;
                case KeyEvent.KEYCODE_MEDIA_PLAY:
                    command = MusicPlayerService.ACTION_PLAY;
                    break;
            }
            if (command != null) {
    ...
    private static void startService(Context context, String command) {
        final Intent intent = new Intent(context, MusicPlayerService.class);
